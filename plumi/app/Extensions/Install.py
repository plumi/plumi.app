...
PRODUCT_DEPENDENCIES = ('LinguaPlone','plone.contentratings','vaporisation','ATVocabularyManager','ATCountryWidget','ContentLicensing','PressRoom','Marshall','collective.flowplayer','plumi.content','plone.app.blob', 'collective.contentlicensing', 'plone.app.imaging', 'plone.app.discussion', 'plumi.migration', 'json_migrator', 'collective.plonebookmarklets', 'quintagroup.plonecomments', 'plumi.skin')
